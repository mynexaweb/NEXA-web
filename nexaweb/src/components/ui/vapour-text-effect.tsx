...
export const Component = () => {
  return (
    <div className="bg-black h-screen w-screen flex justify-center items-center">
      <VaporizeTextCycle
        texts={["NexaWeb", "Builds", "Growth"]}
        font={{ fontFamily: "var(--font-poppins), sans-serif", fontSize: "70px", fontWeight: 700 }}
...
const renderCanvas = ({ framerProps, canvasRef, wrapperSize, particlesRef, globalDpr, currentTextIndex, transformedDensity }: { framerProps: VaporizeTextCycleProps; canvasRef: React.RefObject<HTMLCanvasElement>; wrapperSize: { width: number; height: number }; particlesRef: React.MutableRefObject<Particle[]>; globalDpr: number; currentTextIndex: number; transformedDensity: number }) => {
  ...
  const currentText = framerProps.texts[currentTextIndex] || "NexaWeb";
